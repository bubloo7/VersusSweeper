    ...
    return (
        <Layout>
            <div justify="space-around" align="middle">
                <div xs={24} sm={18} md={10} lg={10} xl={10} xxl={10}>
                    <Image
                        src={HeroImage}
                ...
                <div xs={24} sm={18} md={10} lg={10} xl={10} xxl={10} style={{ marginTop: "20px" }}>
                    <div>
                        ...
                        <div justify="space-around" align="middle" style={{ marginTop: "20px" }}>
