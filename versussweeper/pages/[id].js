...
const ChooseName = dynamic(
  () => import("../components/chooseName/ChooseName"),
  {
    ssr: false,
    loading: () => <Loading />,
  }
...
const GameNotFound = dynamic(
  () => import("../components/gameNotFound/GameNotFound"),
  {
    ssr: false,
    loading: () => <Loading />,
  }
...
const AlterMineSweeper = dynamic(() => import("../components/AlterMinesweeper"), {
    ssr: false,
    loading: () => <Loading />,
});
  ...
  useEffect(() => {
    if (id) {
      socket = io(process.env.NEXT_PUBLIC_BACKEND_URL, {
        path: process.env.NEXT_PUBLIC_SOCKET_PATH || "/api/socket.io",
        query: { id },
      });
